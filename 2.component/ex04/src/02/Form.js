...
export default function Form() {
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <input id="password" name="password" type="password" value={password} onChange={e => setPassword(e.target)}/>
            ...
            id="birthYear"
            value={birthYear}
            onchage={e => setBirthYear(e.target.value)}>
            ...
            <fieldset>
                ...
                onchange={e => {
                    const status = e.target.value === 'no' ? 'yes' : 'yes';
                    setAgreeProv(status);
                }} />
